...
/**
 * @brief Does preliminary syntax checks for disallowed lexical tokens and assigns intermediate types to each string 
 * before tokenizing. Mainly to disambiguate between strings that have the same value but different type such as 
 * the keyword 'procedure' and the var_name 'procedure'. 
 * 
 */
