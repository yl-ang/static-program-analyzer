...
TEST_CASE("Tokenizer Tests") {
    ...
    SECTION("Tokenize PROCEDURE correctly") {
        ...
        std::vector<BasicToken*> input = {new BasicToken("procedure", KEYWORD)};
    ...
    SECTION("Tokenize OPEN_CURLY_BRACE correctly") {
        ...
        std::vector<BasicToken*> input = {new BasicToken("{", SYMBOL)};
        std::vector<Token> resultList = tokenizer.assignTokens(input);
        REQUIRE(expectedResultList == resultList);
    }
    ...
    SECTION("Tokenize NAME correctly") {
        ...
        std::vector<BasicToken*> input = {new BasicToken("happy", _NAME)};
        std::vector<Token> resultList = tokenizer.assignTokens(input);
        REQUIRE(expectedResultList == resultList);
    }
    ...
    SECTION("Tokenize INTEGER correctly") {
        ...
        std::vector<BasicToken*> input = {new BasicToken("123843", _INTEGER)};
        std::vector<Token> resultList = tokenizer.assignTokens(input);
        REQUIRE(expectedResultList == resultList);
    }
    ...
    SECTION("Tokenize READ correctly") {
        ...
        std::vector<BasicToken*> input = {new BasicToken("read", KEYWORD)};
        std::vector<Token> resultList = tokenizer.assignTokens(input);
        REQUIRE(expectedResultList == resultList);
    }
    ...
    SECTION("Tokenize PRINT correctly") {
        ...
        std::vector<BasicToken*> input = {new BasicToken("print", KEYWORD)};
        std::vector<Token> resultList = tokenizer.assignTokens(input);
        REQUIRE(expectedResultList == resultList);
    }
    ...
    SECTION("Tokenize CALL correctly") {
        ...
        std::vector<BasicToken*> input = {new BasicToken("call", KEYWORD)};
        std::vector<Token> resultList = tokenizer.assignTokens(input);
        REQUIRE(expectedResultList == resultList);
    }
    ...
    SECTION("Tokenize IF correctly") {
        ...
        std::vector<BasicToken*> input = {new BasicToken("if", KEYWORD)};
        std::vector<Token> resultList = tokenizer.assignTokens(input);
        REQUIRE(expectedResultList == resultList);
    }
    ...
    SECTION("Tokenize THEN correctly") {
        ...
        std::vector<BasicToken*> input = {new BasicToken("then", KEYWORD)};
        std::vector<Token> resultList = tokenizer.assignTokens(input);
        REQUIRE(expectedResultList == resultList);
    }
    SECTION("Tokenize ELSE correctly") {
        std::vector<Token> expectedResultList = {Token(ELSE, "else", -1)};
        std::vector<BasicToken*> input = {new BasicToken("else", KEYWORD)};
        std::vector<Token> resultList = tokenizer.assignTokens(input);
        REQUIRE(expectedResultList == resultList);
    }
    ...
    SECTION("Procedure definitions should not have statement numbers") {
        ...
        std::vector<BasicToken*> input = {new BasicToken("procedure", KEYWORD), new BasicToken("example", _NAME),
                                          new BasicToken("{", SYMBOL),          new BasicToken("read", KEYWORD),
                                          new BasicToken("example", _NAME),     new BasicToken(";", SYMBOL),
                                          new BasicToken("}", SYMBOL)};
        std::vector<Token> resultList = tokenizer.assignTokens(input);
        REQUIRE(expectedResultList == resultList);
    }
    ...
    SECTION("Statement number correctly handled for while statements") {
        ...
        std::vector<BasicToken*> input = {new BasicToken("while", KEYWORD), new BasicToken("(", SYMBOL),
                                          new BasicToken(")", SYMBOL),      new BasicToken("{", SYMBOL),
                                          new BasicToken("read", KEYWORD),  new BasicToken("example", _NAME),
                                          new BasicToken(";", SYMBOL),      new BasicToken("}", SYMBOL)};
        std::vector<Token> resultList = tokenizer.assignTokens(input);
        REQUIRE(expectedResultList == resultList);
    }
    ...
    SECTION("Statement number correctly handled for if statements") {
        ...
        std::vector<BasicToken*> input = {
            new BasicToken("if", KEYWORD),    new BasicToken("(", SYMBOL), new BasicToken(")", SYMBOL),
            new BasicToken("then", KEYWORD),  new BasicToken("{", SYMBOL), new BasicToken("read", KEYWORD),
            new BasicToken("example", _NAME), new BasicToken(";", SYMBOL), new BasicToken("}", SYMBOL),
            new BasicToken("else", KEYWORD),  new BasicToken("{", SYMBOL), new BasicToken("read", KEYWORD),
            new BasicToken("example", _NAME), new BasicToken(";", SYMBOL), new BasicToken("}", SYMBOL)};
        std::vector<Token> resultList = tokenizer.assignTokens(input);
        REQUIRE(expectedResultList == resultList);
    }
    ...
    SECTION("Statement number correctly handled for read statements") {
        ...
        std::vector<BasicToken*> input = {new BasicToken("read", KEYWORD), new BasicToken("happy", _NAME),
                                          new BasicToken(";", SYMBOL)};
        std::vector<Token> resultList = tokenizer.assignTokens(input);
        REQUIRE(expectedResultList == resultList);
    }
    ...
    SECTION("Statement number correctly handled for assign statements") {
        ...
        std::vector<BasicToken*> input = {new BasicToken("x", _NAME), new BasicToken("=", SYMBOL),
                                          new BasicToken("4", _INTEGER), new BasicToken(";", SYMBOL)};
        std::vector<Token> resultList = tokenizer.assignTokens(input);
        REQUIRE(expectedResultList == resultList);
    }
    ...
    SECTION("Statement number correctly handled for call statements") {
        ...
        std::vector<BasicToken*> input = {new BasicToken("call", KEYWORD), new BasicToken("happy", _NAME),
                                          new BasicToken(";", SYMBOL)};
        std::vector<Token> resultList = tokenizer.assignTokens(input);
        REQUIRE(expectedResultList == resultList);
    }
    ...
    SECTION("Statement number correctly handled for print statements") {
        ...
        std::vector<BasicToken*> input = {new BasicToken("print", KEYWORD), new BasicToken("happy", _NAME),
                                          new BasicToken(";", SYMBOL)};
        std::vector<Token> resultList = tokenizer.assignTokens(input);
        REQUIRE(expectedResultList == resultList);
    }
