...
TEST_CASE("AST Build Tests") {
    ...
    SECTION("Build const factor ast correctly") {
        ...
        ASTNode expectedNode = ASTNode("1", "const", std::vector<std::unique_ptr<ASTNode>>{}, 0);
    ...
    SECTION("Build variable factor ast correctly") {
        ...
        ASTNode expectedNode = ASTNode("a", "var", std::vector<std::unique_ptr<ASTNode>>{}, 0);
        auto queue = makeTokenQueue(inputTokenArray);
    ...
    SECTION("Build assignment to const ast correctly") {
        ...
        std::unique_ptr<ASTNode> nameNode =
            std::make_unique<ASTNode>("a", "var", std::vector<std::unique_ptr<ASTNode>>{}, 0);
        std::unique_ptr<ASTNode> integerNode =
            std::make_unique<ASTNode>("1", "const", std::vector<std::unique_ptr<ASTNode>>{}, 0);
    ...
    SECTION("Build adding two terms correctly") {
        ...
        std::unique_ptr<ASTNode> constNode =
            std::make_unique<ASTNode>("b", "var", std::vector<std::unique_ptr<ASTNode>>{}, 0);
        std::unique_ptr<ASTNode> const2Node =
            std::make_unique<ASTNode>("c", "var", std::vector<std::unique_ptr<ASTNode>>{}, 0);
        std::vector<std::unique_ptr<ASTNode>> children = {};
    ...
    SECTION("Build adding multiple terms correctly") {
        ...
        std::unique_ptr<ASTNode> zNode =
            std::make_unique<ASTNode>("z", "var", std::vector<std::unique_ptr<ASTNode>>{}, 0);
        ...
        auto addNode = std::make_unique<ASTNode>("", "add", std::move(children), 0);
    ...
    SECTION("Build add then mul correctly") {
        ...
        auto mulNode = std::make_unique<ASTNode>("", "mul", std::move(children), 0);
    ...
    SECTION("Build assignment procedure") {
        ...
        auto xNode = std::make_unique<ASTNode>("x", "var", std::vector<std::unique_ptr<ASTNode>>{}, 1);
        auto yNode = std::make_unique<ASTNode>("y", "var", std::vector<std::unique_ptr<ASTNode>>{}, 1);
        ...
        children.push_back(std::move(xNode));
        children.push_back(std::move(yNode));
        auto equalNode = std::make_unique<ASTNode>("", "assign", std::move(children), 1);
    ...
    SECTION("Build read procedure correctly") {
        ...
        children.push_back(std::move(yNode));
        auto readNode = std::make_unique<ASTNode>("", "read", std::move(children), 0);
    ...
    SECTION("Build print procedure correctly") {
        ...
        children.push_back(std::move(yNode));
        auto printNode = std::make_unique<ASTNode>("", "print", std::move(children), 0);
    ...
    SECTION("Build var first then parenthesis then var ast correctly") {
        ...
        auto mulNode = std::make_unique<ASTNode>("", "mul", std::move(children1), 0);
    ...
    SECTION("Build rel_factors correctly for var") {
        ...
        ASTNode aNode = ASTNode("a", "var", std::vector<std::unique_ptr<ASTNode>>{}, 0);
    ...
    SECTION("Build rel_factors correctly for const") {
        ...
        auto queue = makeTokenQueue(inputTokenArray);
        auto result = ast.buildRelationalFactorAST(queue);
        ASTNode oneNode = ASTNode("1", "const", std::vector<std::unique_ptr<ASTNode>>{}, 0);
    ...
    SECTION("Build relational expression with var and const") {
        ...
        std::unique_ptr<ASTNode> zNode =
            std::make_unique<ASTNode>("z", "var", std::vector<std::unique_ptr<ASTNode>>{}, 0);
        std::unique_ptr<ASTNode> oneNode =
            std::make_unique<ASTNode>("1", "const", std::vector<std::unique_ptr<ASTNode>>{}, 0);
        std::vector<std::unique_ptr<ASTNode>> children = {};
    ...
    SECTION("Build relational expression with const and const") {
        ...
        auto result = ast.buildRelationalExpressionAST(queue);
        std::unique_ptr<ASTNode> twoNode =
            std::make_unique<ASTNode>("2", "var", std::vector<std::unique_ptr<ASTNode>>{}, 0);
        std::unique_ptr<ASTNode> oneNode =
            std::make_unique<ASTNode>("1", "const", std::vector<std::unique_ptr<ASTNode>>{}, 0);
        std::vector<std::unique_ptr<ASTNode>> children = {};
    ...
    SECTION("Build not conditional expression") {
        ...
        auto lessThan = std::make_unique<ASTNode>("", "<", std::move(children2), 0);
