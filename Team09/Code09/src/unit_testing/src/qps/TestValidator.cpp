...
//     TestValidator() {}
//
//     explicit TestValidator(const ValidatorSynonymStore& storage) {
...
//     ValidatorSynonymStore testStore;
...
//         std::vector<std::string> inputStatements = {"Select v such that Follows(1,2) pattern a(v,_\"2\"_)", "assign
//         a;",
//                                                     "variable v, v;"};
//         REQUIRE_THROW_SYNTAX_ERROR(validator.isValidValidate(inputStatements));
//     }
